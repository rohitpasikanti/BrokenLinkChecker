...
namespace BrokenLinkChecker
{
    class StrUtil
    {
        ...
        {
            if (CommonFunctions.EmptyString(str) || CommonFunctions.EmptyString(search))
            {
                return str;
            }
            else
        ...
        {
            if (CommonFunctions.EmptyString(str) || CommonFunctions.EmptyString(search) || fromIndex > str.Length)
            {
                return str;
            }
            else
        ...
        public static bool StartsWith(string str, string searchText)
        {
            if (str == null || searchText == null || searchText.Length > str.Length)
            {
                return false;
            }
